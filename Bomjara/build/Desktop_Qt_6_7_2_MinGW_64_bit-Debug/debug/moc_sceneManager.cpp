...
constexpr auto qt_meta_stringdata_CLASSSceneManagerENDCLASS = QtMocHelpers::stringData(
    "SceneManager",
    "goToScene",
    "",
    "number",
...
Q_CONSTINIT const QMetaObject SceneManager::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSSceneManagerENDCLASS_t,
        ...
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'goToHapinnesScene'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'goToBusinessScene'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'goToCasinoScene'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'goToPropertyScene'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
} };
...
void SceneManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->goToScene((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 1: _t->goToMenuScene(); break;
        case 2: _t->goToPlayerScene(); break;
        case 3: _t->goToMoneyScene(); break;
        case 4: _t->goToHealthScene(); break;
        case 5: _t->goToHapinnesScene(); break;
        case 6: _t->goToBusinessScene(); break;
        case 7: _t->goToCasinoScene(); break;
        case 8: _t->goToPropertyScene(); break;
        default: ;
        }
    }
}
